//@ sourceURL=formNumbers-plugin.js
/**
 * Editor plugin for the Forming Numbers template
...
org.ekstep.funtoot.common.extend({
     ...
     * @member {String} type
     * @memberof formNumbers
     */
    type: "org.ekstep.funtoot.formNumbers",
    /**
   ...
   */
    ...
    showDialog: function (event, callback) {
        ...
        ecEditor.getService('popup').open({
            ...
            controller: 'formNumbersController',
            controllerAs: '$ctrl',
            resolve: {
                'instance': function () {
                    return instance;
