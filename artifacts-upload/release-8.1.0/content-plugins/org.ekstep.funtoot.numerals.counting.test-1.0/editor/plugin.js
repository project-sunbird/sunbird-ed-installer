//@ sourceURL=number-counting-plugin-test.js
/**
...
org.ekstep.funtoot.common.extend({
     ...
     */
    type: "org.ekstep.funtoot.numerals.counting.test",
    /**
   * registers events
   * @memberof number-counting
   */
    ...
    loadFabricImage: function () {
        ...
        var version = this.manifest.ver;
        var instance = this;
        var fabricImg = ecEditor.resolvePluginResource(id, version, "/editor/assets/fabric3x3.png");
        if (instance.data.items[instance.data.item_sets[0].id][0].model.cols == 4)
            fabricImg = ecEditor.resolvePluginResource(id, version, "/editor/assets/fabric3x4.png");
    ...
    showDialog: function (event, callback) {
        ...
        ecEditor.getService('popup').open({
            template: 'numerals.counting.test',
            controller: 'numberCountingControllerTest',
            controllerAs: '$ctrl',
            resolve: {
                'instance': function () {
                    return instance;
