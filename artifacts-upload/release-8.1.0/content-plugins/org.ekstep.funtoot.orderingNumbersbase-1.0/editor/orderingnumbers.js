//@ sourceURL=orderingNumbersbase-editor.js
'use strict';
/**
 ...
 */
ftEditorApp.controller('orderingNumbersController', ['$scope', '$http', 'instance', 'configs', function ($scope, $http, instance, configs) {
	$scope.items = [];
	var config = {
