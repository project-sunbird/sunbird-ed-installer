//@ sourceURL=number-counting-test.js
'use strict';
/**
 ...
 */
ftEditorApp.controller('numberCountingControllerTest', ['$scope', '$http', 'instance', function ($scope, $http, instance) {
	...
	var item = {
		...
		model: {
			...
			variables: {
				$expr: "'[2-9],[11-19]'",
				$totalNums: "0",
				$nums: "getNumberSequence($expr, $totalNums, 1)"
			}
		},
		concepts: {
			identifier: 'C7',
