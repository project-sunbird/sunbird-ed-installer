//@ sourceURL=subtractionverticalbase-plugin.js
/**
 * Editor plugin for the vertical subtraction template
...
org.ekstep.funtoot.common.extend({
     ...
     * @member {String} type
     * @memberof subtractionvertical
     */
    type: "org.ekstep.funtoot.subtractionverticalbase",
    /**
    ...
    showDialog: function (event, callback) {
        ...
        ecEditor.getService('popup').open({
            ...
            controller: 'subtractionVerticalController',
            controllerAs: '$ctrl',
            resolve: {
                'instance': function () {
                    return instance;
