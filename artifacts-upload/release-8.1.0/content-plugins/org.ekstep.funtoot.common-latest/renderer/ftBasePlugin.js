...
Plugin.extend({
    ...
    addHint: function (data) {
        ...
        if (PluginManager.getPluginObject(this._ftHintBtnId) && Object.keys(PluginManager.getPluginObject(this._ftHintBtnId)._self._listeners).length > 0)
            PluginManager.getPluginObject(this._ftHintBtnId)._self._listeners = {}
    ...
    addSolution: function (data) {
        ...
        if (PluginManager.getPluginObject(this._ftSolutionBtnId) && Object.keys(PluginManager.getPluginObject(this._ftSolutionBtnId)._self._listeners).length > 0)
            PluginManager.getPluginObject(this._ftSolutionBtnId)._self._listeners = {}
    ...
    addSubmitButton: function (data) {
        ...
        if (PluginManager.getPluginObject(this._ftSubmitButtonId) && Object.keys(PluginManager.getPluginObject(this._ftSubmitButtonId)._self._listeners).length > 0)
            PluginManager.getPluginObject(this._ftSubmitButtonId)._self._listeners = {}
    ...
    addNextButton: function (data) {
        ...
        if (PluginManager.getPluginObject(this._ftNextButtonId) && Object.keys(PluginManager.getPluginObject(this._ftNextButtonId)._self._listeners).length > 0)
            PluginManager.getPluginObject(this._ftNextButtonId)._self._listeners = {}
