//@ sourceURL=mtfOptionBuilder.js
/* global PluginManager */
/**
 * This plugin invokes mtfOption on mtf in the placeholder determined by grid cell. 
 * parentId is the cellId in which option has to be created and the same parentId behaves 
 * as the model for mtfOption.
 * In case option doestn't contain any asset for image or text, mtfOptionBuilder creates a shape 
 * in the specified cell.
 * If attachMh parameter is true, microhint gets attached to the top-left position of the cell.
 * @extends Plugin
 * @fires mtfOption, ftMicroHint
 * @author Amulya (amulya.k@funtoot.com)
 */
Plugin.extend({
    _type: 'mtfOptionBuilder',
    /**
    ...
    initPlugin: function (data) {
        ...
        var mtf = PluginManager.getPluginObject(data.mtfId);
        ...
        PluginManager.invoke('mtfOption', optionObj, mtf, this._stage, this._theme);
