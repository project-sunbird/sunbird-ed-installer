//@ sourceURL=multiplicationhorizontal-editor.js
'use strict';
/**
 ...
 */
ftEditorApp.controller('MultiplicationHorizontalController', ['$scope', '$http', 'instance', function ($scope, $http, instance) {
	$scope.items = [];
	var config = {
	...
	var item = {
		langid: 'en',
		identifier: 'multiplicationhorizontal',
		language: ["English"],
		qid: '',
		subject: "NUM",
		grade: 0,
	...
	var init = function () {
		...
		$scope.config.configFile = ecEditor.resolvePluginResource(instance.manifest.id,
			instance.manifest.ver, '/editor/multiplicationhorizontal.json');
