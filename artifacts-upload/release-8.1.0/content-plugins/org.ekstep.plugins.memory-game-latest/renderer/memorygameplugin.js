/**
 * This plugin renders the org.ekstep.plugins.memory-game and invokes serveral other plugins
 ...
 */
Plugin.extend({
    _type: 'org.ekstep.plugins.memory-game',
    _isContainer: true,
    _render: true,
    _options: [],
     ...
     * @param {object} data,  it is the data object which contains all the information about org.ekstep.plugins.memory-game plugin
     * @memberof org.ekstep.plugins.memory-game
     */
