//@ sourceURL=subtractionvertical-editor.js
'use strict';
/**
 ...
 */
ftEditorApp.controller('subtractionVerticalController', ['$scope', '$http', 'instance', function ($scope, $http, instance) {
	$scope.items = [];
	var config = {
		title: 'Subtract',
		count: 0
	...
	var item = {
		langid: 'en',
		language: ["English"],
		identifier: 'subtractionvertical',
		qid: '',
		subject: "NUM",
		grade: 0,
		gradeLevel: [],
	...
	var init = function () {
		...
		$scope.config.configFile = ecEditor.resolvePluginResource(instance.manifest.id,
			instance.manifest.ver, '/editor/subtractionvertical.json');
