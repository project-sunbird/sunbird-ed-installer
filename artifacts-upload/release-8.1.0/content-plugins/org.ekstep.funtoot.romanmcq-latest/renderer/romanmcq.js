//@ sourceURL=romanmcq.js
/* global PluginManager */
/**
 * This plugin is used to generate roman mcq problems
 * @extends ftBasePlugin
 * @fires grid
 * @author Amulya (amulya.k@funtoot.com)
 */
Plugin.extend({
    _type: 'org.ekstep.funtoot.romanmcq',
    initPlugin: function (data) {
        ...
        if (!data.isSolution && variables != "" && _.isUndefined(model.isOptionsProcessed)) {
            model.options[0].answer = true;
            model.isOptionsProcessed = true;
        }
        var param1Data = {
            param: "overlaySubmit",
            scope: "stage",
        ...
        i18n.onReady().then(function (o) {
            if (!model.isProcessed) {
                ...
                model.i18n[langId][model.model.questionText] = o.translate(model.model.questionText);
                model.i18n[langId]["MH1"] = "Correct";
                model.question = model.model.questionText;
                model.i18n[langId][model.model.hintMsg] = o.translate(model.model.hintMsg, {
                    n: variables.$x
                });
                ...
                for (var i = 0; i < model.model.optionsText.length; i++) {
                    ...
                    if (typeof model.model.optionsText[i] == "string")
                        model.i18n[langId]["OPT" + i] = o.translate(model.model.optionsText[i], {
                            n: variables.$x
                        }).toString();
                }
                for (i = 0; i < model.model.mhs.length; i++) {
                    model.options[i + 1].mh = model.model.mhs[i];
                    model.i18n[langId][model.model.mhs[i]] = o.translate(model.model.mhs[i]);
                }
            }
