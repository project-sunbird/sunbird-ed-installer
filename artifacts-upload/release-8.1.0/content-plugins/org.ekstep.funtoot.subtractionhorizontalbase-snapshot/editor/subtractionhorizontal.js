//@ sourceURL=subtractionhorizontalbase-editor.js
'use strict';
/**
 ...
 */
ftEditorApp.controller('SubtractionHorizontalController', ['$scope', '$http', 'instance', 'configs', function ($scope, $http, instance, configs) {
	$scope.items = [];
	var config = {
