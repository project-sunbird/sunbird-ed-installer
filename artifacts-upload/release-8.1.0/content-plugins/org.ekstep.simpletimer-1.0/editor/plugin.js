...
org.ekstep.contenteditor.basePlugin.extend({
    ...
    */
    newInstance: function() {
        ...
        var timeText = ecEditor.instantiatePlugin('org.ekstep.text', textProps, this);
    ...
    onConfigChange: function(key, value) {
        ...
        switch (key) { 
            ...
            case 'name':
                ...
                break;
            case 'behaviour':
                this.attributes.behaviour = value || 0;
                break;
            case 'type':
    ...
    */ 
    getConfig: function() {
        ...
        config.behaviour = this.attributes.behaviour;
    ...
    */
    setTargetStage: function(instanceName){
        ...
        for(var i=0; i<allStages.length; i++){
            var children = ecEditor.getStagePluginInstances(allStages[i].id,instance.manifest.id);
    ...
    */
    setTimeRemaining: function(time,unit) {
        ...
        instance.editorObj.setText(hours+":"+minutes+":"+seconds);
    },
            ...
            if(children != undefined){
                ...
                for(var j=0; j<children.length; j++){
                    ...
                    if(name != undefined && name===this.attributes.name){
                        ...
                        p.attributes.behaviour = this.attributes.behaviour;
                        ...
                        var plugin = ecEditor.getPluginInstance(children[j].id);
