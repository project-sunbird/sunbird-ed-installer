 ...
 * @class org.ekstep.plugins.mcqplugin1.EditorPlugin
 * @extends org.ekstep.contenteditor.basePlugin
 * @author Jagadish P <jagadish.pujari@tarento.com>
 */
mcqplugin1.EditorPlugin = org.ekstep.contenteditor.basePlugin.extend({
 
   /**
     *  Adds event listeners and loads template and controller
     *  @memberof org.ekstep.plugins.mcqplugin1.EditorPlugin#
     */
     currentInstance: undefined,
    initialize: function() { 
        var instance = this;
        ecEditor.addEventListener("org.ekstep.plugins.mcqplugin1:showpopup", this.loadHtml, this);
...
//# sourceURL=mcqplugin1EditorPlugin.js
