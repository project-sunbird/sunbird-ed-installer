...
org.ekstep.funtoot.common.extend({
    ...
    initPlugin: function (data) {
        ...
        i18n.onReady().then(function (o) {
            ...
            var question = o.translate("QUESTION_TEXT", {
                divident: o.translateNumber(variables.$nums[0], numericLangId).displayValue,
                divisor: o.translateNumber(variables.$nums[1], numericLangId).displayValue
            });
    ...
    evaluate: function (model, evalModel) {
        ...
        var ruleToMmcMhMap = {
            ...
            isDivisorInsteadOfQuotient: {
                mmc: "C289",
                mh_r: "ISDIVISORINSTEADOFQUOTIENT",
                mh_q: "ISDIVISORINSTEADOFQUOTIENT"
            },
            isDividentMulOf100AndDivisorIs100: {
                mmc: "C287",
                mh_r: "ISDIVIDENTMULOF100ANDDIVISORIS100_R",
                mh_q: "ISDIVIDENTMULOF100ANDDIVISORIS100_Q"
            },
            isDividentMulOf10AndDivisorIs10: {
                mmc: "C287",
                mh_r: "ISDIVIDENTMULOF10ANDDIVISORIS10_R",
                mh_q: "ISDIVIDENTMULOF10ANDDIVISORIS10_Q"
            },
            isDividentNotMulOf10AndDivisorIs10: {
                mmc: "C287",
                mh_r: "ISDIVIDENTNOTMULOF10ANDDIVISORIS10_R",
                mh_q: "ISDIVIDENTNOTMULOF10ANDDIVISORIS10_Q"
            },
            isDividentNotMulOf100AndDivisorIs100: {
                mmc: "C287",
                mh_r: "ISDIVIDENTNOTMULOF100ANDDIVISORIS100_R",
                mh_q: "ISDIVIDENTNOTMULOF100ANDDIVISORIS100_Q"
            },
            isDividentNotMulOf1000AndDivisorIs1000: {
                mmc: "C287",
                mh_r: "ISDIVIDENTNOTMULOF1000ANDDIVISORIS1000_R",
                mh_q: "ISDIVIDENTNOTMULOF1000ANDDIVISORIS1000_Q"
            },
            isDividentMulOf1000AndDivisorIs1000: {
                mmc: "C287",
                mh_r: "ISDIVIDENTMULOF1000ANDDIVISORIS1000_R",
                mh_q: "ISDIVIDENTMULOF1000ANDDIVISORIS1000_Q"
            },
            isExactlyDivisible: {
                mmc: "C726",
                mh_r: "ISEXACTLYDIVISIBLE_R",
                mh_q: "ISEXACTLYDIVISIBLE_R"
            },
            interChangedQandR: {
                mmc: "C590",
                mh_r: "INTERCHANGEDQANDR",
                mh_q: "INTERCHANGEDQANDR"
            },
            incompleteDivision: {
                mmc: "C734",
                mh_r: "INCOMPLETEDIVISION_R",
                mh_q: "INCOMPLETEDIVISION_Q"
            }
        };
        var fibmodels = this._item.getModelValue().model.fibModels;
        var q = _.filter(fibmodels, function (fmodel) {
            return fmodel.loc == 'Q';
        })
        if (model.u.trim() == '') {
            if (model.loc == 'R' && q[0].u != "") {
            ...
            _.each(model.model.fibModels, function (m) {
                if (m.w) {
                    var mod = {
                        ...
                        user: {
                            quotient: m.loc == 'Q' ? i18n.toNumber(m.u) : null,
                            remainder: m.loc == 'R' ? i18n.toNumber(m.u) : null,
                        },
