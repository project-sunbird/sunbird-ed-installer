 ...
 * @class org.ekstep.plugins.createquestion.EditorPlugin
 * @extends org.ekstep.contenteditor.basePlugin
 * @author Jagadish P <jagadish.pujari@tarento.com>
 */
myplugin.EditorPlugin = org.ekstep.contenteditor.basePlugin.extend({

   /**
     *  Adds event listeners and loads template and controller
     *  @memberof org.ekstep.plugins.createquestion.EditorPlugin#
     */
     currentInstance: undefined,
    initialize: function() { 
        var instance = this;
        ecEditor.addEventListener("org.ekstep.plugins.myplugin:showpopup", this.loadHtml, this);
...
//# sourceURL=mypluginEditorPlugin.js
