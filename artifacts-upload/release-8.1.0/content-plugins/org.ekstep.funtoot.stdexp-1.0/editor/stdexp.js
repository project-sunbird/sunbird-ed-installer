 ...
 */
ftEditorApp.controller('stdexpController', ['$scope', '$http', 'instance', function ($scope, $http, instance) {
	$scope.items = [];
	var config = {
	...
	$scope.addQuestion = function () {
		...
		newItem.model.mask = $scope.config.selectedConfig.itemData.Mask;
		newItem.model.pvInNumberNames = $scope.config.selectedConfig.itemData.PvInNumberNames;
		newItem.model.isStandardForm = $scope.config.selectedConfig.itemData.IsStandardForm;
		newItem.model.isFrac = $scope.config.selectedConfig.itemData.isFrac;
		newItem.model.numberSystem = $scope.config.selectedConfig.itemData.NumberSystem;
	...
	var init = function () {
		...
		$scope.config.configFile = ecEditor.resolvePluginResource(instance.manifest.id,
			instance.manifest.ver, '/editor/stdexp.json');
