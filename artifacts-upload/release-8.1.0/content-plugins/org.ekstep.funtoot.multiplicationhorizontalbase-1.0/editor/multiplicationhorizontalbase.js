//@ sourceURL=multiplicationhorizontalbase-editor.js
'use strict';
/**
 ...
 */
ftEditorApp.controller('MultiplicationHorizontalController', ['$scope', '$http', 'instance', 'configs', function ($scope, $http, instance, configs) {
	$scope.items = [];
	var config = {
