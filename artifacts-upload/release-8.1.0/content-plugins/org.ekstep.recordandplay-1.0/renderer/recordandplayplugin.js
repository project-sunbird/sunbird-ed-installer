...
Plugin.extend({
    ...
    addStageEvents: function() {
        ...
        if (this._stage._data.events) {
            if (!this._stage._data.events.event) {
                this._stage._data.events.event = [];
            }
            this._stage._data.events.event.push(record_start_event);
            this._stage._data.events.event.push(record_stop_event);
        } else if (this._stage._data.event) {
            if (!this._stage._data.events) {
...
//# sourceURL=RecordAndPlayRendererPlugin.js
