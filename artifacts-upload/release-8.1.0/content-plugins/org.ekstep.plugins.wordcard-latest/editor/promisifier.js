org.ekstep.plugins.WordCard.Promisifier = Class.extend({
    /**
     * Promisifier class to create promises and keep track of them
     * @constructs org.ekstep.plugins.WordCard.Promisifier
     ...
     * @memberof org.ekstep.plugins.WordCard.Promisifier#
 ...
 */
org.ekstep.plugins.WordCard.Promisifier.create = function($q) {
    return new org.ekstep.plugins.WordCard.Promisifier($q);
}

//# sourceURL=Promisifier.js
