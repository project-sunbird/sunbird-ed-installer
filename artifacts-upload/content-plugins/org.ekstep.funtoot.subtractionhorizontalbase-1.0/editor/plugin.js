//@ sourceURL=subtraction-horizontalbase.js
/**
...
org.ekstep.funtoot.common.extend({
     ...
     */
    type: "org.ekstep.funtoot.subtractionhorizontalbase",
    /**
     ...
     *  @memberof subtractionhorizontal
     */
    ...
    showDialog: function (event, callback) {
        ...
        ecEditor.getService('popup').open({
            ...
            controller: 'SubtractionHorizontalController',
            controllerAs: '$ctrl',
            resolve: {
                'instance': function () {
                    return instance;
