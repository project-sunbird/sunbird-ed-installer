//@ sourceURL=additionvertical-editor.js
'use strict';
/**
 ...
 */
ftEditorApp.controller('additionverticalController', ['$scope', '$http', 'instance', function ($scope, $http, instance) {
	$scope.items = [];
	var config = {
		title: 'Addition',
		count: 0
	...
	var init = function () {
		...
		$scope.config.configFile = ecEditor.resolvePluginResource(instance.manifest.id,
			instance.manifest.ver, '/editor/addition.vertical.json');
