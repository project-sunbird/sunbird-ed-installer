//@ sourceURL=readsettime-editor.js
'use strict';
/**
 ...
 */
ftEditorApp.controller('readsettimeCtrl', ['$scope', '$http', 'instance', function ($scope, $http, instance) {
    $scope.items = [];
    var config = {
    ...
    $scope.addQuestion = function () {
        ...
        newItem.model.mmc = $scope.config.selectedConfig.itemData.ConceptCode;
    ...
    var init = function () {
        ...
        $scope.config.configFile = ecEditor.resolvePluginResource(instance.manifest.id,
            instance.manifest.ver, '/editor/readsettime.json');
