/**
 * This plugin renders the org.ekstep.memory-game and invokes serveral other plugins
 * create a content (learn aksharas through a series of memorygame)
 * @class org.ekstep.memory-game
 * @extends Plugin
 * @author Devendra Singh <devendra.singh@tarento.com>
 */
Plugin.extend({
    _type: 'org.ekstep.memory-game',
    _isContainer: true,
    _render: true,
    _options: [],
     ...
     * @param {object} data,  it is the data object which contains all the information about org.ekstep.memory-game plugin
     * @memberof org.ekstep.memory-game
     */
...
//# sourceURL=memoryGameRendererPlugin.js