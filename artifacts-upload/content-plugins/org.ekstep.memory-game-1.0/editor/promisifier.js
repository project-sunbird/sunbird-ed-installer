...
org.ekstep.plugins.MemoryGame.Promisifier = Class.extend({
    /**
     * Promisifier class to create promises and keep track of them
     * @constructs org.ekstep.plugins.MemoryGame.Promisifier
     ...
     * @memberof org.ekstep.plugins.MemoryGame.Promisifier#
 ...
 */
org.ekstep.plugins.MemoryGame.Promisifier.create = function($q) {
    return new org.ekstep.plugins.MemoryGame.Promisifier($q);
}
