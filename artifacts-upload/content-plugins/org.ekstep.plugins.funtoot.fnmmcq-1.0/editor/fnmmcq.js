 ...
 */
ftEditorApp.controller('fnmmcqController', ['$scope', '$http', 'instance', function ($scope, $http, instance) {
    $scope.items = [];
    var config = {
    ...
    var item = {
        ...
        type: 'mcq',
        qtype: 'mcq',
        template_id: 'org.ekstep.plugins.funtoot.genericmcq',
        template: 'org.ekstep.plugins.funtoot.genericmcq',
    ...
    $scope.addQuestion = function () {
        ...
        newItem.model.mcqType = $scope.config.selectedConfig.itemData.mcqType;
        newItem.mmc = $scope.config.selectedConfig.itemData.mmc;
        var optionsText = [];
        var optionsImage = [];
        var mhs = [];
    ...
    var init = function () {
        ...
        $scope.config.configFile = ecEditor.resolvePluginResource(instance.manifest.id,
            instance.manifest.ver, '/editor/fnmmcq.json');
