//@ sourceURL=numberline-editor.js
'use strict';
/**
 ...
 */
ftEditorApp.controller('NumberlineController', ['$scope', '$http', 'instance', function ($scope, $http, instance) {
    $scope.items = [];
    var config = {
        title: 'Numberline',
        count: 0
    ...
    $scope.addQuestion = function () {
        ...
        newItem.model.operation = $scope.config.selectedConfig.itemData.Operation
    ...
    var init = function () {
        ...
        $scope.config.configFile = ecEditor.resolvePluginResource(instance.manifest.id,
            instance.manifest.ver, '/editor/numberline.json');
