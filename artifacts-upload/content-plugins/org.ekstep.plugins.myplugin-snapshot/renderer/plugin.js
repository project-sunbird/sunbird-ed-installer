...
Plugin.myplugin.RendererPlugin = Plugin.extend({
    _type: 'myplugin',
    _isContainer: false,
    _render: true,
    ...
    renderOption: function(index, value) {
        ...
        if (value.audio) {
            let imageSrc = EkstepRendererAPI.resolvePluginResource("org.ekstep.plugins.myplugin", "1.0", "renderer/assets/audio.png");
