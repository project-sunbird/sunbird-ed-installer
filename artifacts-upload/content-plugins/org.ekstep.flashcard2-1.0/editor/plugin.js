...
EkstepEditor.basePlugin.extend({
    type: "org.ekstep.flashcard2",
    imageId: "",
    audioId: "",
    wordInfo: {},

    initialize: function() {
        EkstepEditorAPI.addEventListener("org.ekstep.flashcard2:showpopup", this.loadHtml, this);
        setTimeout(function() {
            var templatePath = EkstepEditor.config.pluginRepo + '/org.ekstep.flashcard2-1.0/editor/flashcardeditorconfig.html';
            var controllerPath = EkstepEditor.config.pluginRepo + '/org.ekstep.flashcard2-1.0/editor/flashcardeditorapp.js';
    ...
    newInstance: function() {
        ...
        if (wordInfo.pictures != undefined) { 
            ...
            wordInfo.pictures = [];
            wordInfo.pictures[0] = EkstepEditor.config.absURL + instance.relativeURL("assets/noimageavailable.png");
            var tempURL = wordInfo.pictures[0].split("/");
            imageId = tempURL[tempURL.length - 1];
        }
