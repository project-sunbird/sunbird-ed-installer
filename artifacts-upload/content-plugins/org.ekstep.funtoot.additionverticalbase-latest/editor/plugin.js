//@ sourceURL=additionverticalbase-plugin.js
/**
...
org.ekstep.funtoot.common.extend({
     ...
     * @member {String} type
     * @memberof additionverticalbase
     */
    type: "org.ekstep.funtoot.additionverticalbase",
    /**
    ...
    showDialog: function (event, callback) {
        ...
        ecEditor.getService('popup').open({
            ...
            controller: 'additionverticalController',
            controllerAs: '$ctrl',
            resolve: {
                'instance': function () {
                    return instance;
