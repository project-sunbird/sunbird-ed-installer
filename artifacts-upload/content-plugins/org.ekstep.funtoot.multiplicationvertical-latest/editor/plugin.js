//@ sourceURL=multiplicationvertical-plugin.js
/**
...
org.ekstep.funtoot.common.extend({
     ...
     * @member {String} type
     * @memberof multiplicationvertical
     */
    type: "org.ekstep.funtoot.multiplicationvertical",
    /**
   ...
   */
    ...
    showDialog: function (event, callback) {
        ...
        ecEditor.getService('popup').open({
            ...
            controller: 'multiplicationverticalController',
            controllerAs: '$ctrl',
            resolve: {
                'instance': function () {
                    return instance;
