...
org.ekstep.contenteditor.basePlugin.extend({
    type: "org.ekstep.akshara-teaching",
    initialize: function() {
        var instance = this;
        ecEditor.addEventListener("org.ekstep.akshara-teaching:showpopup", this.loadHtml, this);
        setTimeout(function() {
            var templatePath = ecEditor.resolvePluginResource(instance.manifest.id, instance.manifest.ver, "editor/aksharaeditorconfig.html");
            var controllerPath = ecEditor.resolvePluginResource(instance.manifest.id, instance.manifest.ver, "editor/aksharaeditorapp.js");
