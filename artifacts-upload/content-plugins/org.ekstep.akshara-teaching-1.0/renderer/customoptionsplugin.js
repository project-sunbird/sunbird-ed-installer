/**
 * This method renders coptions to read lhs opitons and rhs options details and invoke coption to add them on canvas
 * @memberof coptions
 */
Plugin.extend({
    _type: 'coptions',
    ...
    initPlugin: function(data) {
        ...
        if (value && _.isArray(value) && value.length > 0) {
            if (layout === 'table' && (_.isFinite(data.cols) || _.isFinite(data.rows))) {
                this._parent._controller.setModelValue(model, this.registerResValues(value));
                this.renderTableLayout(value);
            }
        }
    },
    /**
     * This method creates table layout and invoke coption plugin for each cell in the table
    ...
    /**
     * This method response value for each option in the cmtf
     * @param {array} options, it is the array of options
     * @memberof coptions
     */
    registerResValues: function(options) {
