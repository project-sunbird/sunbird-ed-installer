...
Plugin.mcqplugin1.RendererPlugin = Plugin.extend({
    _type: 'mcqplugin1',
    _isContainer: false,
    _render: true,
    ...
    headerWithImageAudio: function(headerDiv) {
        instance=this;
        var audioImage = _pluginData.question.audio ? EkstepRendererAPI.resolvePluginResource("org.ekstep.plugins.mcqplugin1", "1.0", "renderer/assets/audio.png") : "";
    ...
    renderOption: function(index, value) {
        ...
        if (value.audio) {
            let imageSrc = EkstepRendererAPI.resolvePluginResource("org.ekstep.plugins.mcqplugin1", "1.0", "renderer/assets/audio.png");
...
//#sourceURL=mcqplugin1RendererPlugin.js