//@ sourceURL=previewhelper-renderer.js
/* global PluginManager */
/**
 * This plugin helps us preview funtoot questions on the ekstep question set plugin (quiz plugin).
 * @extends ftBasePlugin
 * @fires grid, activitybase
 * @author Amit (amit.dawar@funtoot.com)
 */
org.ekstep.funtoot.common.extend({
    _type: 'org.ekstep.plugins.funtoot.previewhelper',
    initPlugin: function (data) {
        data["data"] = {}
        data["config"] = {}
        data["data"]["__cdata"] = JSON.stringify(this._theme._data.controller["0"].__cdata)
