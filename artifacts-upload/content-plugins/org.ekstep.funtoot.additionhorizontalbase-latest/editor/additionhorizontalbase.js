//@ sourceURL=additionhorizontalbase-editor.js
'use strict';
/**
 ...
 */
ftEditorApp.controller('AdditionHorizontalController', ['$scope', '$http', 'instance', 'configs', function ($scope, $http, instance, configs) {
	$scope.items = [];
	var config = {
