//@ sourceURL=subtractionverticalbase-renderer.js
...
org.ekstep.funtoot.common.extend({
    _type: 'org.ekstep.funtoot.subtractionverticalbase',
    /**
        ...
        if (this.onEvaluate(instance)) {
            ...
            if (model.model.qType == 0) {
                ...
                if (showErrorOnAns) {
                    ...
                    var tbcobj = PluginManager.getPluginObject('answerBox-mh-mhicon');
                    tbcobj._self.visible = this.areMicrohintsEnabled();
                    tbcobj._data.visible = this.areMicrohintsEnabled();
                }
            }
            // missing subtrahend
