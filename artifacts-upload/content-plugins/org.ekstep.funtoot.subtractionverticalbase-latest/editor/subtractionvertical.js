//@ sourceURL=subtractionverticalbase-editor.js
'use strict';
/**
 ...
 */
ftEditorApp.controller('subtractionVerticalController', ['$scope', '$http', 'instance', 'configs', function ($scope, $http, instance, configs) {
	$scope.items = [];
	var config = {
		title: 'Subtract',
		count: 0
