//@ sourceURL=numberNames-editor.js
'use strict';
/**
 ...
 */
ftEditorApp.controller('numberNamesController', ['$scope', '$http', 'instance', function ($scope, $http, instance) {
	$scope.items = [];
	var config = {
		title: 'Number names',
		count: 0
	...
	$scope.addQuestion = function () {
		...
		newItem.model.questionStem = $scope.config.selectedConfig.itemData.QuestionText;
		config.locales = {
	...
	var init = function () {
		...
		$scope.config.configFile = ecEditor.resolvePluginResource(instance.manifest.id,
			instance.manifest.ver, '/editor/numbernames.json');
