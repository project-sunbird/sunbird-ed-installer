...
content  = templatefile("${path.module}/global-cloud-values.yaml.tfpl", {
    ...
    azure_terms_and_conditions_container_name = var.terms_and_conditions_container,
    azure_public_state_container_name = var.public_state_container,
    azure_sourcing_state_container_name = var.sourcing_state_container,
